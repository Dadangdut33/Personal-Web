	...
	return (
		<>
			<Head>
				...
				<title>Project Tags Dashboard | Dadangdut33 Personal Web</title>
			</Head>
			<Wrapper {...props}>
				<IdAndCount {...props} parent="project" parentSearch="tags" fetchLink="/project/tags" title="Project Tags" />
			</Wrapper>
		</>
	);
};
