...
export const Blog: NextPage<IBlogProps> = (props) => {
	...
	useEffect(() => {
		...
		fillDataPage(api_url + "/admin", perPage, curPage, setLoadingDataPage, setCurPage, setPages, setDataPage);
		fillDataAll(api_url + "/admin", setLoadingDataAll, setDataAllPage, fillExtraData);
