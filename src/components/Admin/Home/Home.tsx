...
import { IconNotebook, IconHistory, IconLink, IconRefresh, IconChartPie, IconExternalLink } from "@tabler/icons";
...
import { domain, formatBytes, SERVER_V1, analyticsPublicId } from "../../../helper";
...
export const DashboardHome: NextPage<IDashboardProps> = (props) => {
	...
	const dataElProps = [
		...
		{ name: "project", icon: IconLink, fetchLink: "/project/stats" },
				...
				>
					...
					<Paper withBorder p="md" radius="md">
						...
						<div style={{ position: "relative" }}>
							...
							<Link href={`https://analytics.dadangdut33${domain}/share/${analyticsPublicId}/Dadangdut33%20Web`} target={"_blank"}>
								<a>
