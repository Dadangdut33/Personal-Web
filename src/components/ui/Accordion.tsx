...
// Base: https://neobrutalism-components.vercel.app/react/components/Accordion
export default function Accordion({ question, answer, className }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <p className="p-4 md:p-5 text-sm md:text-base leading-relaxed md:leading-relaxed">{answer}</p>
      </div>
    </div>
  );
}
