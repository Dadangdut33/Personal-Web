...
// Base: https://neobrutalism-components.vercel.app/react/components/Dropdown
export default function Dropdown({ items, text }: { items: { name: string; link: string }[]; text: string }) {
  const [isActiveDropdown, setIsActiveDropdown] = useState(false);

  return (
    <div data-state={isActiveDropdown ? "open" : "closed"} className="relative group">
      <button
