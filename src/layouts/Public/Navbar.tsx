        ...
        <div className="flex gap-5 justify-end">
          <div className="flex w-[160px] items-center justify-end gap-5 m900:hidden m400:gap-3">
            <Button className={pathName === '/' ? BtnActiveClass : 'bg-transparent'} component={Link} href="/">
              <p className={`text-xl font-base ${pathName !== '/' && 'dark:darkText'}`}>About</p>
            </Button>
            <Button
              ...
              href="/project"
            >
              <p className={`text-xl font-base ${pathName !== '/project' && 'dark:darkText'}`}>Project</p>
            </Button>
            <Button className={pathName === '/blog' ? BtnActiveClass : 'bg-transparent'} component={Link} href="/blog">
              <p className={`text-xl font-base ${pathName !== '/blog' && 'dark:darkText'}`}>Blog</p>
            </Button>
          </div>
          <div>
            <BtnToggleColor />
