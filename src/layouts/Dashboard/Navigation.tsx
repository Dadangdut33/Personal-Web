...
import { BriefcaseBusiness, Images, LucideIcon } from 'lucide-react';
...
const mediaManagerAppNav: navData[] = [
  {
    title: 'Media',
    links: [{ label: 'Media', icon: Images, link: `${DASHBOARD_PATH}/media` }],
  },
];
    ...
    links: [
      {
        ...
        links: [
          {
            label: 'Manage',
            link: `${DASHBOARD_PATH}/blog`,
            icon: IconListSearch,
          },
          {
            label: 'Category',
            link: `${DASHBOARD_PATH}/blog/category`,
            icon: IconCategory,
          },
          {
            label: 'Create',
            link: `${DASHBOARD_PATH}/blog/create`,
            icon: IconPlus,
          },
        ],
      },
      {
        ...
        links: [
          {
            label: 'Manage',
            link: `${DASHBOARD_PATH}/project`,
            icon: IconListSearch,
          },
          {
            label: 'Category',
            link: `${DASHBOARD_PATH}/project/category`,
            icon: IconCategory,
          },
          {
            label: 'Create',
            link: `${DASHBOARD_PATH}/project/create`,
            icon: IconPlus,
          },
        ],
      },
