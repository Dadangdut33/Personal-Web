...
import { colShortLink, colUser, urlSaferRegex } from "../lib";
...
export const shortLinkModel = mongoose.models.shortlinks || model<IShortLinkModel>(colShortLink, shortLinkSchema);
